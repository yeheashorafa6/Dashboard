      ...
      <div className="w-full xl:w-1/3 flex flex-col gap-4">
        <div className="bg-white p-2 rounded-md">
          ...
          <div className="text-gray-700 rounded-lg text-sm p-4 flex gap-4 flex-wrap mt-4">
            <Link className="p-3 bg-sky rounded-md" href={`/List/Classes?supervisorId=${"teacher2"}`}>Teacher&apos;s Classes</Link>
            <Link className="p-3 bg-skyight rounded-md" href={`/List/Students?teacherId=${"teacher2"}`}>Teacher&apos;s Students</Link>
            <Link className="p-3 bg-primaryPurple rounded-md" href={`/List/Lessons?teacherId=${"teacher2"}`}>Teacher&apos;s Lseeons</Link>
            <Link className="p-3 bg-secondaryYellow rounded-md" href={`/List/Exams?teacherId=${"teacher3"}`}>Teacher&apos;s Exams</Link>
            <Link className="p-3 bg-primaryPurpleLight rounded-md" href={`/List/Assignments?teacherId=${"teacher2"}`}>Teacher&apos;s Assignments</Link>
          </div>
        </div>
        {/* PERFORMANCE */}
        <Performance/>
